...
sub create {
    ...
    eval {
      $self->debug_message("SHU: INPUT VAL Preparing ...");
      #   sleep(180);
        ...
        $self->debug_message("SHU: Step 7 Preparing ...");
        ...
        $self->debug_message("SHU: Step 7 run aligner ...");
        ...
        $self->debug_message("SHU: Step 8 Preparing ...");
    ...
    $self->debug_message("SHU: Step 9-10 Preparing ...");
    ...
    $self->debug_message("SHU: Step 11 Preparing ...");
    ...
    $self->debug_message("SHU: Step 12 Preparing ...");
    ...
    $self->debug_message("SHU: Step 13 Preparing ...");
    ...
    $self->debug_message("SHU: Step 14 Preparing ...");
...
sub postprocess_bam_file {
    ...
    my $sam_file = "/opt/gms-d/bams/hcc1395_1tenth_percent/out.sam";
    my $bam2 = "/opt/gms-d/bams/hcc1395_1tenth_percent/out.bam";
    system("cp -r $bam2 $bam_file");
    system("samtools view -bS -F 4 $sam_file > $bam_file");
    my $output_file = $bam_file . '.flagstat';
